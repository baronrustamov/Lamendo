...
insert into reply(reply_post_id, parent_reply_id, user, date, reply, img_filename, img_uid, ip)
    values (1, null, "000rre9228edfe", strftime('%Y-%m-%d %H:%M', 'now'), "This is the FIRST reply.", "12345.png", "1a2b3c4d5e", "1.2.3.4");

insert into reply(reply_post_id, parent_reply_id, user, date, reply, img_filename, img_uid, ip)
    values (1, 1, "111rrv9228edfe", strftime('%Y-%m-%d %H:%M', 'now'), "Replying to FIRST reply.", null, null, "1.2.3.4");

insert into reply(reply_post_id, parent_reply_id, user, date, reply, img_filename, img_uid, ip)
    values (1, null, "222rrv9228edfe", strftime('%Y-%m-%d %H:%M', 'now'), "This is the SECOND reply.", null, null, "1.2.3.4");
