...
insert into post(post_board_id, user, date, post, img_filename, img_uid)
    values (1, '3938ae9228edfe', strftime('%Y-%m-%d %H:%M', 'now'), 'This is the FIRST post.', null, null);
insert into post(post_board_id, user, date, post, img_filename, img_uid)
    values (1, '393bae9228edfe', strftime('%Y-%m-%d %H:%M', 'now'), 'This is the SECOND post.', null, null);


insert into reply(reply_post_id, user, date, reply, img_filename, img_uid)
    values (1, "393aae9228edfe", strftime('%Y-%m-%d %H:%M', 'now'), "This is the FIRST reply.", "12345.png", "1a2b3c4d5e");

insert into reply(reply_post_id, user, date, reply, img_filename, img_uid)
    values (1, "3938av9228edfe", strftime('%Y-%m-%d %H:%M', 'now'), "This is the SECOND reply.", null, null);
